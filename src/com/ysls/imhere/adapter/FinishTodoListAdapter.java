...
public class FinishTodoListAdapter extends BaseAdapter  {
	protected static final String TAG = "FinishTodoListAdapter";
	private Context mContext;
	private List<TodoModel> lists;
	private CustomListView mCustomListView;

	public FinishTodoListAdapter(Context context, List<TodoModel> lists,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.tv_todo_out_time.setText("已完成");
