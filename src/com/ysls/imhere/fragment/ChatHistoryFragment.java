...
public class ChatHistoryFragment extends Fragment {
	...
	private RelativeLayout mAddFriendView;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		mAddFriendView = (RelativeLayout) getView().findViewById(R.id.rl_add_friends_tips);
		constact=(Button) mAddFriendView.findViewById(R.id.btn_constact);
