...
import com.ysls.imhere.adapter.FinishTodoListAdapter;
...
public class FinishTodoListFragment extends Fragment  {
	
	private static final String TAG = "FinishTodoListFragment";
	...
	private void init() {
		adapter = new FinishTodoListAdapter(mContext, todolist, mCustomListView);
